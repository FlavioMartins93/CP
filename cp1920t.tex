...
\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{(\Conid{A}\times\mathit B)\mathbin{*}}
           \ar@/^-1pc/[r]^{\ensuremath{\Varid{collect}}}
&
    \ensuremath{(\Conid{A}\times\mathit B\mathbin{*})\mathbin{*}}
           \ar@/^-1pc/[l]^{\ensuremath{\Varid{discollect}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{discollect}\;\Varid{x}\mathrel{=}\Varid{concat}\;[\mskip1.5mu [\mskip1.5mu (\Varid{k},\Varid{a})\mid \Varid{a}\leftarrow \Varid{d}\mskip1.5mu]\mid (\Varid{k},\Varid{d})\leftarrow \Varid{x}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{\Conid{Dict}}
           \ar[d]_-{\ensuremath{\Varid{tar}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]^{\ensuremath{\Varid{outExp}}}
&
    \ensuremath{\Conid{S}\mathbin{+}\Conid{S}\times\Conid{Dict}\mathbin{*}}
           \ar[d]^{\ensuremath{\Conid{F}\;\Varid{tar}}}
\\
    \ensuremath{(\Conid{S}\times\Conid{S})\mathbin{*}}
&
    \ensuremath{\Conid{S}\mathbin{+}\Conid{S}\times(\Conid{S}\times\Conid{S})\mathbin{**}}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}[\mskip1.5mu \Varid{k},\Varid{p}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{k}}{\Varid{p}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;\Varid{s}\mathrel{=}[\mskip1.5mu (\text{\tt \char34 \char34},\Varid{s})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{p}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;(\lambda (\Varid{x},\Varid{y})\to (\Varid{a}\plus \Varid{x},\Varid{y}))\mathbin{\$}\Varid{concat}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{(\Conid{S}\times\Conid{S})\times\Conid{Dict}}
           \ar[d]_-{|(g)|}
           \ar[r]_-{\ensuremath{\Varid{g}\mathrel{=}(\p2\mathbin{+}\Varid{f})\comp \Varid{distr}\comp ((\Varid{id}\times\Varid{id})\times\Varid{outExp})}}
&
    \ensuremath{\Conid{S}\mathbin{+}(\Conid{S}\times((\Conid{S}\times\Conid{S})\times\Conid{Dict})\mathbin{*})}
           \ar[d]^{\ensuremath{\Conid{F}\;\ana{\Varid{g}}}}
\\
    \ensuremath{\Conid{Dict}}
           \ar[d]_-{\ensuremath{\cata{\Varid{f}}}}
           \ar@/^-1pc/[r]^{\ensuremath{\Varid{outExp}}}
&
    \ensuremath{\Conid{S}\mathbin{+}(\Conid{S}\times\Conid{Dict}\mathbin{*})}
           \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{f}}}}
           \ar@/^-1pc/[l]^{\ensuremath{\Varid{inExp}}}
\\
     \ensuremath{\Conid{Dict}}
&
     \ensuremath{\Conid{S}\mathbin{+}(\Conid{S}\times\Conid{Dict}\mathbin{*})}
           \ar[l]^-{\ensuremath{\Varid{f}\mathrel{=}\Varid{inExp}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times(\map \;\Varid{inExp}\comp \Varid{set}\comp \map \;\Varid{outExp})))}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{pal}\;\Varid{sin}\;\Varid{dic}\mathrel{=}\Varid{hyloExp}\;\Varid{gc}\;\Varid{g}\;((\Varid{pal},\Varid{sin}),\Varid{dic})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}(\p2+\Varid{f})\comp \Varid{distr}\comp ((\Varid{id}\times\Varid{id})\times\Varid{outExp}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;((\Varid{p},\Varid{s}),(\Varid{t},\Varid{d})){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid (\Varid{p}\equiv \text{\tt \char34 \char34})\mathrel{\wedge}(\Varid{s}\equiv \text{\tt \char34 \char34})\mathrel{=}(\Varid{t},\map \;(\lambda \Varid{x}\to ((\Varid{p},\Varid{s}),\Varid{x}))\;\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid (\Varid{p}\equiv \text{\tt \char34 \char34})\mathrel{=}(\Varid{t},((\text{\tt \char34 \char34},\Varid{s}),\Conid{Var}\;\Varid{s})\mathbin{:}\map \;(\lambda \Varid{x}\to ((\Varid{p},\text{\tt \char34 \char34}),\Varid{x}))\;\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{checkMatch}\;(\Varid{d},[\mskip1.5mu \Varid{head}\;\Varid{p}\mskip1.5mu])\equiv \Conid{True}\mathrel{=}(\Varid{t},\map \;(\lambda \Varid{x}\to \Varid{chooseBranch}\;((\Varid{x},\Varid{p}),\Varid{s}))\;\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{checkMatch}\;(\Varid{d},[\mskip1.5mu \Varid{head}\;\Varid{p}\mskip1.5mu])\equiv \Conid{False}\mathrel{=}(\Varid{t},\Varid{auxIns}\;(\Varid{p},\Varid{s})\mathbin{:}\map \;(\lambda \Varid{x}\to ((\text{\tt \char34 \char34},\text{\tt \char34 \char34}),\Varid{x}))\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gc}\mathrel{=}\Varid{inExp}\comp (\Varid{id}+(\Varid{id}\times(\map \;\Varid{inExp}\comp \Varid{set}\comp \map \;\Varid{outExp}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{chooseBranch}\mathbin{::}((\Conid{Dict},\Conid{String}),\Conid{String})\to ((\Conid{String},\Conid{String}),\Conid{Dict}){}\<[E]%
\\
\>[B]{}\Varid{chooseBranch}\;((\Varid{d},\Varid{p}),\Varid{s})\mathrel{=}{}\<[27]%
\>[27]{}\alt{\underline{((\text{\tt \char34 \char34},\text{\tt \char34 \char34}),\Varid{d})}}{\Varid{f}}\mathbin{\$}(\Varid{outExp}\;\Varid{d})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(\Varid{t},\Varid{dic})\mathrel{=}\mathbf{if}\;(\Varid{head}\;\Varid{t}\equiv \Varid{head}\;\Varid{p})\;\mathbf{then}\;((\Varid{tail}\;\Varid{p},\Varid{s}),\Varid{inExp}\mathbin{\$}i_2\;(\Varid{t},\Varid{dic}))\;{}\<[75]%
\>[75]{}\mathbf{else}\;((\text{\tt \char34 \char34},\text{\tt \char34 \char34}),\Varid{inExp}\mathbin{\$}i_2\;(\Varid{t},\Varid{dic})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{checkMatch}\mathbin{::}([\mskip1.5mu \Conid{Dict}\mskip1.5mu],\Conid{String})\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{checkMatch}\;(\Varid{d},\Varid{s})\mathrel{=}\Varid{elem}\;\Conid{True}\mathbin{\$}\map \;\alt{\Varid{false}}{(\equiv \Varid{s})\comp \p1}\mathbin{\$}\map \;\Varid{outExp}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxIns}\mathbin{::}(\Conid{String},\Conid{String})\to ((\Conid{String},\Conid{String}),\Conid{Dict}){}\<[E]%
\\
\>[B]{}\Varid{auxIns}\;([\mskip1.5mu \p1\mskip1.5mu],\p2)\mathrel{=}((\text{\tt \char34 \char34},\text{\tt \char34 \char34}),\Conid{Term}\;[\mskip1.5mu \p1\mskip1.5mu]\;[\mskip1.5mu \Conid{Var}\;\p2\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{auxIns}\;(\Varid{p},\Varid{s})\mathrel{=}((\Varid{tail}\;\Varid{p},\Varid{s}),\Conid{Term}\;[\mskip1.5mu \Varid{head}\;\Varid{p}\mskip1.5mu]\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{(\Conid{S}\times\Conid{Dict})}
           \ar[d]_-{|(g)|}
           \ar[r]_-{\ensuremath{\Varid{g}\mathrel{=}[\mskip1.5mu \Varid{v2},i_2\comp \Varid{k}\mskip1.5mu]\comp \Varid{distl}\comp (\Varid{out}\times\Varid{id})}}
&
    \ensuremath{(\Conid{S}\mathbin{+}(\Conid{S}\times(\Conid{S}\times\Conid{Dict})\mathbin{*}))}
           \ar[d]^{\ensuremath{\Conid{F}\mid (\Varid{g})\mid }}
\\
    \ensuremath{\Conid{Dict}}
           \ar[d]_-{\ensuremath{\cata{\Varid{f}}}}
           \ar@/^-1pc/[r]^{\ensuremath{\Varid{outExp}}}
&
    \ensuremath{\Conid{S}\mathbin{+}(\Conid{S}\times\Conid{Dict}\mathbin{*})}
           ...
           \ar@/^-1pc/[l]^{\ensuremath{\Varid{inExp}}}
\\
     \ensuremath{\Conid{S}\mathbin{*}}
&
     \ensuremath{\Conid{S}\mathbin{+}(\Conid{S}\times\Conid{S}\mathbin{**})}
           \ar[l]^-{\ensuremath{\Varid{f}\mathrel{=}[\mskip1.5mu \Varid{singl},\Varid{concat}\comp \p2\mskip1.5mu]}}
}
\end{eqnarray*}
...
\column{29}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{d}\mathrel{=}\Varid{\Conid{Cp}.cond}\;((\equiv \mathrm{0})\comp \length )\;\underline{\Conid{Nothing}}\;(\Conid{Just}\comp \Varid{set})\mathbin{\$}\Varid{hyloExp}\;\Varid{cg}\;\Varid{ag}\;(\Varid{d},\Varid{p})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{ag}\mathrel{=}\alt{\Varid{v}}{i_2\comp \Varid{k}}{}\<[29]%
\>[29]{}\comp \Varid{distl}\comp (\Varid{outExp}\times\Varid{id}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;((\Varid{s1},\Varid{d}),\Varid{s2}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{s1}\equiv \text{\tt \char34 \char34}\mathrel{=}(\Varid{s1},\map \;(\lambda \Varid{x}\to (\Varid{x},\Varid{s2}))\;\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \length \;\Varid{s2}\mathbin{>}\mathrm{0}\mathrel{\wedge}\Varid{head}\;\Varid{s1}\equiv \Varid{head}\;\Varid{s2}\mathrel{=}(\Varid{s1},\map \;(\lambda \Varid{x}\to (\Varid{x},\Varid{tail}\;\Varid{s2}))\;\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{s1},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{v}\;(\Varid{s2},\text{\tt \char34 \char34})\mathrel{=}i_1\;\Varid{s2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{v}\;(\Varid{s2},\anonymous )\mathrel{=}i_2\;(\text{\tt \char34 \char34},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{cg}\mathrel{=}\alt{\Varid{singl}}{\Varid{concat}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{maisDir}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outBTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times((\fun{BTree} \;\Conid{A})\times(\fun{BTree} \;\Conid{A})))}
           \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}(\Varid{id}\times(\cata{\Varid{g}}\times\cata{\Varid{g}}))}}
\\
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times((\mathrm{1}\mathbin{+}\Conid{A})\times(\mathrm{1}\mathbin{+}\Conid{A})))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{gdir}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gdir}\;(\Varid{a},(\anonymous ,\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gdir}\;(\Varid{a},(\anonymous ,\Varid{d}))\mathrel{=}\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=5cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{maisEsq}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outBTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times((\fun{BTree} \;\Conid{A})\times(\fun{BTree} \;\Conid{A})))}
           \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}(\Varid{id}\times(\cata{\Varid{g}}\times\cata{\Varid{g}}))}}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{gesq}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gesq}\;(\Varid{a},(\Conid{Nothing},\anonymous ))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gesq}\;(\Varid{a},(\Varid{e},\anonymous ))\mathrel{=}\Varid{e}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.8cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
          \ar[d]_-{\ensuremath{\cata{\conj{\Varid{h}}{\Varid{k}}}}}
          \ar[r]_-{\ensuremath{\Varid{outBTree}}}
          \ar@/^-7pc/[dd]^{\ensuremath{\p1\comp \cata{\conj{\Varid{h}}{\Varid{k}}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\conj{\Varid{k}}{\Varid{h}}}}}
\\
    \ensuremath{\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}}
          \ar[d]^{\ensuremath{\p1}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times((\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
          \ar[l]^-{\ensuremath{\conj{\Varid{k}}{\Varid{h}}}}
\\
    \ensuremath{\fun{BTree} \;\Conid{A}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\mathrel{=}\p1\comp (\Varid{cataBTree}\;\conj{\alt{\underline{(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty})))}}{\Varid{chooseSide}}}{\alt{\underline{\Conid{Empty}}}{\Conid{Node}\comp (\Varid{id}\times(\p2\times\p2))}})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{chooseSide}\;(\Varid{v},((\Varid{ee},\Varid{ed}),(\Varid{de},\Varid{dd}))){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{a}\mathbin{>}\Varid{v}\mathrel{=}(\Conid{Node}\;(\Varid{v},(\Varid{ed},\Varid{de}))){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}(\Conid{Node}\;(\Varid{v},(\Varid{ee},\Varid{dd}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
          \ar[d]_-{\ensuremath{\cata{\conj{\Varid{h}}{\Varid{k}}}}}
          \ar[r]_-{\ensuremath{\Varid{outBTree}}}
          \ar@/^-6pc/[dd]^{\ensuremath{\p1\comp \cata{\conj{\Varid{h}}{\Varid{k}}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\conj{\Varid{k}}{\Varid{h}}}}}
\\
    \ensuremath{\mathrm{2}\times\fun{BTree} \;\Conid{A}}
          \ar[d]^{\ensuremath{\p1}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times((\mathrm{2}\times\fun{BTree} \;\Conid{A})\times(\mathrm{2}\times\fun{BTree} \;\Conid{A}))}
          \ar[l]^-{\ensuremath{\conj{\Varid{k}}{\Varid{h}}}}
\\
    \ensuremath{\mathrm{2}}
}
...
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\mathrel{=}\p1\comp (\Varid{cataBTree}\;\conj{\alt{\Varid{true}}{\Varid{noOrd}}}{\alt{\underline{\Conid{Empty}}}{\Varid{reconstructBT}}}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{reconstructBT}\mathbin{::}(\Varid{a},((\Conid{Bool},\fun{BTree} \;\Varid{a}),(\Conid{Bool},\fun{BTree} \;\Varid{a})))\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{reconstructBT}\;(\Varid{a},((\Varid{bd},\Varid{d}),(\Varid{br},\Varid{e})))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{d},\Varid{e})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Nodo ordenado}{}\<[E]%
\\
\>[B]{}\Varid{noOrd}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow (\Varid{a},((\Conid{Bool},\fun{BTree} \;\Varid{a}),(\Conid{Bool},\fun{BTree} \;\Varid{a})))\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{noOrd}\;(\Varid{a},((\Varid{bd},\Varid{e}),(\Varid{br},\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{bd}\equiv \Conid{False}\mathrel{\vee}\Varid{br}\equiv \Conid{False}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{maisDir}\;\Varid{d}\equiv \Conid{Nothing}\mathrel{\wedge}\Varid{maisEsq}\;\Varid{e}\equiv \Conid{Nothing}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{maisDir}\;\Varid{d}\equiv \Conid{Nothing}\mathrel{=}\Conid{Just}\;\Varid{a}\geq \Varid{maisDir}\;\Varid{e}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{maisEsq}\;\Varid{e}\equiv \Conid{Nothing}\mathrel{=}\Conid{Just}\;\Varid{a}\leq \Varid{maisEsq}\;\Varid{d}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Just}\;\Varid{a}\geq \Varid{maisDir}\;\Varid{e}\mathrel{\wedge}\Conid{Just}\;\Varid{a}\leq \Varid{maisEsq}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},((\Conid{Node}\;(\Varid{l},(\Varid{ll},\Varid{lr}))),\Varid{r})))\mathrel{=}\Conid{Node}\;(\Varid{l},(\Varid{ll},(\Conid{Node}\;(\Varid{a},(\Varid{lr},\Varid{r}))))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{l},(\Conid{Node}\;(\Varid{r},(\Varid{rl},\Varid{rr}))))))\mathrel{=}\Conid{Node}\;(\Varid{r},((\Conid{Node}\;(\Varid{a},(\Varid{l},\Varid{rl}))),\Varid{rr})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}\Varid{id}\times(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
    \ensuremath{{(\fun{BTree} \;\Conid{A})}^{{\mathrm{2}}^{\mathbin{*}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times({(\fun{BTree} \;\Conid{A})}^{{\mathrm{2}}^{\mathbin{*}}}\times{(\fun{BTree} \;\Conid{A})}^{{\mathrm{2}}^{\mathbin{*}}}))}
          \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\mathrel{=}\Varid{flip}\mathbin{\$}\Varid{cataBTree}\mathbin{\$}\alt{\underline{\cdot }\comp \underline{\Conid{Empty}}}{\Varid{apRot}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{apRot}\;(\Varid{a},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{\Conid{Cp}.cond}\;((\equiv \mathrm{0})\comp \length )\;(\Conid{Node}\comp \conj{\underline{\Varid{a}}}{\conj{\Varid{e}}{\Varid{d}}})\;(\Varid{k}\;(\Varid{a},(\Varid{e},\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;(\Varid{a},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{\Conid{Cp}.cond}\;\Varid{head}\;(\Varid{rrot}\comp \Conid{Node}\comp \conj{\underline{\Varid{a}}}{\conj{\Varid{e}\comp \Varid{tail}}{\Varid{d}\comp \Varid{nil}}})\;(\Varid{lrot}\comp \Conid{Node}\comp \conj{\underline{\Varid{a}}}{\conj{\Varid{e}\comp \Varid{nil}}{\Varid{d}\comp \Varid{tail}}}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=5cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
          \ar[d]_-{\ensuremath{\Varid{extLTree}\mathrel{=}\cata{\Varid{g}}}}
          \ar[r]_-{\ensuremath{\Varid{outBdt}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{A}\times(\Conid{Bdt}\;\Conid{A}\times\Conid{Bdt}\;\Conid{A}))}
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{a},(\Varid{b1},\Varid{b2})))\mathrel{=}i_2\;(\Varid{a},(\Varid{b1},\Varid{b2})){}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=5cm{
    \ensuremath{\Conid{A}}
          \ar[d]_-{\ensuremath{\Varid{anaBdt}\mathrel{=}\ana{\Varid{g}}}}
          \ar[r]_-{\ensuremath{\Varid{g}}}
&
    \ensuremath{\mathit B\mathbin{+}(\Conid{S}\times(\Conid{A}\times\Conid{A}))}
          \ar[d]^{\ensuremath{\Conid{F}\;\ana{\Varid{g}}}}
\\
    \ensuremath{\Conid{Bdt}\;\mathit B}
&
    \ensuremath{\mathit B\mathbin{+}(\Conid{S}\times(\Conid{Bdt}\;\mathit B\times\Conid{Bdt}\;\mathit B))}
          \ar[l]^-{\ensuremath{\Varid{inBdt}}}
}
\end{eqnarray*}
...
\xymatrix@C=5cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
          \ar[d]_-{\ensuremath{\Varid{navLTree}\mathrel{=}\cata{\Varid{g}}}}
          \ar[r]_-{\ensuremath{\Varid{outLTree}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
    \ensuremath{{\mathsf{LTree}\;\Conid{A}}^{{\mathrm{2}}^{\mathbin{*}}}}
&
    \ensuremath{\Conid{A}\mathbin{+}({\mathsf{LTree}\;\Conid{A}}^{{\mathrm{2}}^{\mathbin{*}}}\times{\mathsf{LTree}\;\Conid{A}}^{{\mathrm{2}}^{\mathbin{*}}})}
          \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{navLTree}\mathrel{=}\Varid{cataLTree}\mathbin{\$}\alt{\underline{\cdot }\comp \Conid{Leaf}}{\Varid{nav}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{nav}\;(\Varid{e},\Varid{d})\mathrel{=}\Varid{\Conid{Cp}.cond}\;((\equiv \mathrm{0})\comp \length )\;(\Conid{Fork}\comp \conj{\Varid{e}}{\Varid{d}})\;(\Varid{\Conid{Cp}.cond}\;\Varid{head}\;(\Varid{e}\comp \Varid{tail})\;(\Varid{d}\comp \Varid{tail})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
    \ensuremath{{\mathsf{LTree}\;\Conid{A}}^{{\fun{BTree} \;\mathrm{2}}^{\mathbin{*}}}}
&
    \ensuremath{\Conid{A}\mathbin{+}({\mathsf{LTree}\;\Conid{A}}^{{\fun{BTree} \;\mathrm{2}}^{\mathbin{*}}}\times{\mathsf{LTree}\;\Conid{A}}^{{\fun{BTree} \;\mathrm{2}}^{\mathbin{*}}})}
          \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\mathbin{\$}\alt{\underline{\cdot }\comp \Conid{Leaf}}{\Varid{nav}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{nav}\;(\Varid{e},\Varid{d})\mathrel{=}\alt{\Conid{Fork}\comp \conj{\Varid{e}}{\Varid{d}}\comp \underline{\Conid{Empty}}}{\Varid{\Conid{Cp}.cond}\;\p1\;(\Varid{e}\comp \p1\comp \p2)\;(\Varid{d}\comp \p2\comp \p2)}\comp \Varid{outBTree}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
          \ar[d]^{\ensuremath{\Conid{F}\;\cata{\Varid{g}}\mathrel{=}\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
    \ensuremath{{\fun{Dist}\;(\mathsf{LTree}\;\Conid{A})}^{\fun{BTree} \;(\fun{Dist}\;\mathrm{2})}}
&
    \ensuremath{\Conid{A}\mathbin{+}({\fun{Dist}\;(\mathsf{LTree}\;\Conid{A})}^{\fun{BTree} \;(\fun{Dist}\;\mathrm{2})}\times{\fun{Dist}\;(\mathsf{LTree}\;\Conid{A})}^{\fun{BTree} \;(\fun{Dist}\;\mathrm{2})})}
          \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lt}\mathrel{=}\Conid{Fork}\;(\Conid{Fork}\;(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\Conid{Fork}\;(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\Conid{Leaf}\;\text{\tt \char34 N~precisa\char34})),\Conid{Leaf}\;\text{\tt \char34 N~precisa\char34}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bt}\mathbin{::}\fun{BTree} \;(\fun{Dist}\;\Conid{Bool}){}\<[E]%
\\
\>[B]{}\Varid{bt}\mathrel{=}\Conid{Node}\;(\Varid{prob1},(\Varid{esq},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\Varid{esq}\mathrel{=}\Conid{Node}\;(\Varid{prob2},(\Conid{Empty},\Conid{Node}\;(\Varid{prob3},(\Conid{Empty},\Conid{Empty})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prob1}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.15}),(\Conid{False},\mathrm{0.85})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{prob2}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.8}),(\Conid{False},\mathrm{0.2})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{prob3}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.6}),(\Conid{False},\mathrm{0.4})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{out}\mathrel{=}{}\<[8]%
\>[8]{}\Conid{D}\;[\mskip1.5mu {}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}\mbox{\onelinecomment ((Fork(Leaf "Precisa",Fork(Leaf "Precisa", Leaf "Nao precisa"))) , 0.15),}{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\mathrm{0.80}\mathbin{*}\mathrm{0.15}),{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}\mbox{\onelinecomment (Fork(Leaf "Precisa", Leaf "Nao precisa"), 0.2*0.15),}{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\mathrm{0.6}\mathbin{*}\mathrm{0.2}\mathbin{*}\mathrm{0.15}),{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}(\Conid{Leaf}\;\text{\tt \char34 N~Precisa\char34},\mathrm{0.4}\mathbin{*}\mathrm{0.2}\mathbin{*}\mathrm{0.15}),{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}(\Conid{Leaf}\;\text{\tt \char34 N~Precisa\char34},\mathrm{0.85}){}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{apPr}\mathbin{::}(\fun{Dist}\;\Varid{a},\Conid{Probability})\to \fun{Dist}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{apPr}\;(\Varid{d},(\Conid{P}\;\Varid{p}))\mathrel{=}\Conid{D}\;(\map \;(\lambda (\Varid{a},\Varid{b})\to (\Varid{a},(\Varid{b}\mathbin{*}\Varid{p})))\;(\Varid{unD}\;\Varid{d})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{joinDists}\mathbin{::}\fun{Dist}\;\Varid{a}\to \fun{Dist}\;\Varid{a}\to \fun{Dist}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{joinDists}\;\Varid{a}\;\Varid{b}\mathrel{=}\Conid{D}\;((\Varid{unD}\;\Varid{a})\plus (\Varid{unD}\;\Varid{b})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{headDist}\mathbin{::}\fun{Dist}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{headDist}\mathrel{=}\p1\comp \Varid{head}\comp \Varid{unD}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pbnavLTree}\mathrel{=}\Varid{cataLTree}\mathbin{\$}\alt{\underline{\cdot }\comp \Varid{return}\comp \Conid{Leaf}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Varid{e},\Varid{d})\mathrel{=}\alt{\underline{\cdot }\mathbin{\$}\Varid{return}\;(\Conid{Fork}\;((\Varid{headDist}\mathbin{\$}\Varid{e}\;\Conid{Empty}),(\Varid{headDist}\mathbin{\$}\Varid{d}\;\Conid{Empty})))}{\Varid{h}\;(\Varid{e},\Varid{d})}\comp \Varid{outBTree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\;(\Varid{e},\Varid{d})\mathrel{=}\uncurry{\Varid{joinDists}}\comp \conj{\Varid{apPr}\comp \conj{\p1\comp \p2}{\p1\comp \p1}}{\Varid{apPr}\comp \conj{\p2\comp \p2}{\p2\comp \p1}}\comp ((\conj{(\mathbin{??})\;\Varid{id}}{(\mathbin{??})\;\neg }\comp \Varid{norm})\times(\Varid{e}\times\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{put}\mathrel{=}\uncurry{\Conid{Translate}}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{chooseTruchet}\mathrel{=}\mathsf{fmap}\;(\Varid{\Conid{Cp}.cond}\;(\equiv \mathrm{1})\;\underline{\Varid{truchet1}}\;\underline{\Varid{truchet2}})\mathbin{\$}\Varid{randomRIO}\;(\mathrm{0}\mathbin{::}\Conid{Integer},\mathrm{1}\mathbin{::}\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{generator}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\{\mskip1.5mu \Varid{x}\leftarrow [\mskip1.5mu \mathbin{-}\Varid{a}\mathbin{/}\mathrm{2},(\mathbin{-}\Varid{a}\mathbin{/}\mathrm{2}\mathbin{+}\mathrm{80})\mathinner{\ldotp\ldotp}\Varid{a}\mathbin{/}\mathrm{2}\mathbin{-}\mathrm{80}\mskip1.5mu];\Varid{y}\leftarrow [\mskip1.5mu \mathbin{-}\Varid{b}\mathbin{/}\mathrm{2},(\mathbin{-}\Varid{a}\mathbin{/}\mathrm{2}\mathbin{+}\mathrm{80})\mathinner{\ldotp\ldotp}\Varid{b}\mathbin{/}\mathrm{2}\mathbin{-}\mathrm{80}\mskip1.5mu];\Varid{return}\;(\mathsf{fmap}\;(\Varid{put}\;(\Varid{x},\Varid{y}))\;\Varid{chooseTruchet})\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{main}\mathrel{=}\mathsf{fmap}\;\Conid{Pictures}\;(\Varid{sequence}\;(\Varid{generator}\;(\mathrm{800},\mathrm{800})))\bind \Varid{display}\;\Varid{janela}\;\Varid{white}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
